			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="cms-form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<!--<?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
...
<!-- /#wrapper -->
<script type="text/javascript" src="/new_info/Public/js/admin/form.js"></script>
