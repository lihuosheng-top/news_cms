                    ...
                    <div class="table-responsive">
                        <form id="cms-listorder">
                            <table class="table table-bordered table-hover cms-table">
                                ...
                                <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><span class="glyphicon glyphicon-edit" aria-hidden="true" id="cms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span> <a
                                                                                       href="javascript:void(0)"
                                                                                       attr-id="<?php echo ($menu["menu_id"]); ?>"
                                                                                       id="cms-delete" attr-a="menu"
                                                                                       attr-message="删除"><span
                        ...
                        <div>
                            <button id="button-listorder" type="button" class="btn btn-primary dropdown-toggle"><span
                                    class="glyphicon glyphicon-plus" aria-hidden="true"></span>更新排序
                            </button>
                        </div>
                    </div>
                </div>
