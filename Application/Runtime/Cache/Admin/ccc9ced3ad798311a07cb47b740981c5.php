  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- /.row -->
            <div>
                <button url="/admin.php?c=content&a=add"
                        id="button-add" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加
                </button>
            </div>
            <div class="row">
                <form action="/admin.php" method="get">
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="catid">
                                ...
                                <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $k=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>"
                                    <?php if($sitenav['menu_id'] == $catid): ?>selected="selected"<?php endif; ?>
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <input class="form-control" name="title" type="text" value="<?php echo ($titleValue); ?>"
                                   placeholder="文章标题"/>
                        ...
                        <form id="cms-listorder">
                            <table class="table table-bordered table-hover cms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><input size=4 type='text' name='listorder[<?php echo ($new["news_id"]); ?>]'
                                                   value="<?php echo ($new["listorder"]); ?>"/></td><!--6.7-->
                                        ...
                                        <td><span attr-status="<?php if( $new['status'] == 1): ?>0
                                            <?php else: ?>
                                            1<?php endif; ?>" attr-id="<?php echo ($new["news_id"]); ?>" class="news_cursor cms-on-off"
                                            id="cms-on-off" ><?php echo (status($new["status"])); ?></span></td>
                                        <td><span class="news_cursor glyphicon glyphicon-edit" aria-hidden="true"
                                                  id="cms-edit" attr-id="<?php echo ($new["news_id"]); ?>"></span>
                                            <a href="javascript:void(0)" id="cms-delete" attr-id="<?php echo ($new["news_id"]); ?>"
                                               attr-message="删除">
                                                <span class="glyphicon glyphicon-remove-circle"
                                                      aria-hidden="true"></span>
                                            </a>
                                            <a target="_blank" href="/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>"
                                               class="news_cursor glyphicon glyphicon-eye-open" aria-hidden="true"></a>
