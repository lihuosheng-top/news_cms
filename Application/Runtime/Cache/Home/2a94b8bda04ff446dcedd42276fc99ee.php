...
<head>
  ...
  <link rel="stylesheet" href="/new_info/Public/css/bootstrap.css" type="text/css" />
  <link rel="stylesheet" href="/new_info/Public/css/home/main.css" type="text/css" />
</head>
<body>
<header id="header">
  <div class="navbar-inverse">
    <div class="container">
      <div class="navbar-header">
        <a href="/">
          <img src="/new_info/Public/images/logo.png" alt="">
        </a>
      </div>
      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <div class="banner-left">
            <div class="banner-info"><span>阅读数</span><i class="news_count node-<?php echo ($result['topPicNews'][0]['news_id']); ?>" news-id="<?php echo ($result['topPicNews'][0]['news_id']); ?>" id="node-<?php echo ($result['topPicNews'][0]['news_id']); ?>"><?php echo ($result['count']); ?></i></div>
...
<script src="/new_info/Public/js/count.js"></script>
</html>